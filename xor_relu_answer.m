...
W11 = (2*rand(k,1)-1)*0.5;
 ...
 W1 = (2*rand(3,13)-1)*sqrt(12/16);
 W2 = (2*rand(13,13)-1)*sqrt(12/26);
 W3 = (2*rand(13,13)-1)*sqrt(12/26);
 W4 = (2*rand(13,13)-1)*sqrt(12/26);
 W5 = (2*rand(13,13)-1)*sqrt(12/26);
 W6 = (2*rand(13,13)-1)*sqrt(12/26);
 W7 = (2*rand(13,13)-1)*sqrt(12/26);
 W8 = (2*rand(13,13)-1)*sqrt(12/26);
 W9 = (2*rand(13,13)-1)*sqrt(12/26);
 W10 = (2*rand(13,13)-1)*sqrt(12/26);
 W11 = (2*rand(13,1)-1)*sqrt(12/14);
